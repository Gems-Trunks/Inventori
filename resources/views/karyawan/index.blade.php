               ...
               <tr>
                  ...
                  <td class="text-center">
                     <div class="btn-group btn-group-sm gap-1" role="group">
                        ...
                        <a href="{{ route('karyawan.edit', $k->id) }}" class="btn btn-sm btn-warning text-white" title="Edit">
                           <i class="bi bi-pencil"></i>
                        </a>
                        <form action="{{ route('karyawan.destroy', $k->id) }}" id="form-delete-{{ $k->id }}" method="POST"
                           class="d-inline">
                           @csrf
                           @method('DELETE')
